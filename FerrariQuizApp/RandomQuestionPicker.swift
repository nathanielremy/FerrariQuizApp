...
var questions: [[String: String]] = [
    ["Q": "In Ferrari F12 TDF, What does the 'TDF' stand for?", "rightAnswer": "Tour de France", "false1": "Secret Ferrari abbreviation", "false2": "Total Demon Features", "false3": "Total Driving Force"],
    ...
    ["Q": "In Ferrari 458, what does the '458' stand for?", "rightAnswer": "4.5 Litre V8", "false1": "458 horse power", "false2": "458 cars have been manufactured", "false3": "$458, 000"],
    ...
    ["Q": "What car was named after Ferrari's founder?", "rightAnswer": "Ferrari Enzo", "false1": "575 Maranello", "false2": "Scuderia", "false3": "SuperAmerica"]
]
...
class RandomQuestionPicker {
    ...
    func randomQuestion(questionLabel: UILabel, answer1: UIButton, answer2: UIButton, answer3: UIButton, answer4: UIButton) {
        ...
        let display = GKRandomSource.sharedRandom().nextInt(upperBound: 4)
        ...
        if (display == 0) {
            ...
            answer4.setTitle(questions[index]["false3"], for: .normal)
